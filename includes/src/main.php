<section id="section-1" class="parallax-window" data-parallax="scroll" data-image-src="assets/img/1.jpg">
    <div class="container">
        <div class="slider">
            ...
            <div class="title">
                <h3>our place</h3><span>place what you need</span></div>
            <div class="slider-container">
                <div class="swiper-container">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <img src="assets/img/2.jpg" alt="your image descrition">
                        </div>
                        <div class="swiper-slide">
